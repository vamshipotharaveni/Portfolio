        ...
        <div id="contact" className='contact'>
            ...
            <div className='contact-section'>
                <div className='contact-left'>
                    <h1>Let's talk</h1>
                    <p>I'm currently Available to work with a projects and be an employee for a company, so feel free to ask anything that you want me to work on.You can contact anytime</p>
